...
<div class="col-md-12">
                    ...
                    <h5 class="card-header danger-color white-text text-center py-4">
                        <strong>APPOINTMENT FOR DONERS</strong>
                        
                    </h5>
                   <?php if(isset($_SESSION['add-doner'])) :  ?>
                <p style="color: red; text-align:center; background-color: #ea090935;">
                <?= $_SESSION['add-doner']  ;
                unset($_SESSION['add-doner']); ?>
                 </p>
            <?php endif ?>
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        ...
                        <!-- Form -->
                        <form class="text-center" style="color: #757575;" action="add-doner-logic.php" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <!-- Phone Number -->
                                    <div class="md-form">
                                        <input type="tel" id="materialRegisterFormPhone" class="form-control"
                                            name="phone">
                                ...
                                <div class="col">
                                    ...
                                    <div class="md-form">
                                        <input type="time" id="materialRegisterFormTime" class="form-control"
                                            aria-describedby="materialRegisterFormPhoneHelpBlock" name="time">
  ...
  <select name="blood-grp">
    ...
    <option value="AB-">AB-</option>
                                ...
                                <!-- pplace -->
                                <div style="margin-left: 200px;" class="md-form">
                            ...
                            <button style="color: white;" class="btn btn-danger btn-rounded btn-block my-4 waves-effect z-depth-0"
                                type="submit" name="submit">GET APPOINTMENT</button>
