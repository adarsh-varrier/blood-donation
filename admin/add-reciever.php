...
<div class="col-md-12">
                    ...
                    <h5 class="card-header danger-color white-text text-center py-4">
                        <strong>REQUEST APPOINTMENT FOR RECEIVER</strong>
                    </h5>
                    <?php if(isset($_SESSION['add-reciever'])) :  ?>
                <p style="color: red; text-align:center; background-color: #ea090935;">
                <?= $_SESSION['add-reciever']  ;
                unset($_SESSION['add-reciever']); ?>
                 </p>
            <?php endif ?>
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        ...
                        <!-- Form -->
                        <form class="text-center" style="color: #757575;" action="add-reciever-logic.php" method="POST">
                                ...
                                <div class="col">
                                    ...
                                    <div class="md-form">
                                        <input type="text" id="materialRegisterFormPhone" class="form-control"
                                            aria-describedby="materialRegisterFormPhoneHelpBlock" name="phone">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <!-- Date -->
                                    <div class="md-form">
                                        <input type="date" id="materialRegisterFormDate" class="form-control" name="date" min="<?php echo date('Y-m-d'); ?>">
                                ...
                                <div class="col">
                                    ...
                                    <div class="md-form">
                                        <input type="time" id="materialRegisterFormTime" class="form-control"
                                            aria-describedby="materialRegisterFormPhoneHelpBlock" name="time" min="<?php echo date('H:i'); ?>">
  ...
  <select name="blood-grp">
    ...
    <option value="AB-">AB-</option>
                                ...
                                <!-- pplace -->
                                <div class="md-form">
                                    <input type="text" id="materialRegisterFormBloodGroup" class="form-control" name="place">
                            ...
                            <!-- Sign up button -->
                            <button name="submit" style="color: white;" class="btn btn-danger btn-rounded btn-block my-4 waves-effect z-depth-0"
